...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expressions, we will set it null for now.
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Operand is true and sets a Display_Value
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that AC clears ll inputs from the Calculator screen.
