...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //If player is equal to 'O', the o.png is placed in the HTML
...
//drawline() function is called to draw a line on the screen if he condition is met.
function checkWinConditions() {
    ...
    //X 2, 5, 8 condition.
    else if (arrayIncludes('X2', 'X5', 'X8')) { drawWinLine(508, 50, 508, 558) }
    //X 6, 4, 2 condition.
    else if (arrayIncludes('X6', 'X4', 'X2')) { drawWinLine(100, 508, 510, 90) }
    //X 0, 4, 8 condition.
    else if (arrayIncludes('X0', 'X4', 'X8')) { drawWinLine(100, 100, 520, 520) }
    //O 0, 1, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axus data we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        //This method clears content from the past loop iteration.
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        //This animation stops our animation loop.
        cancelAnimationFrame(animationLoop);
    }
    //This line disallows clicking while the win sound is playing
    disableClick();
    //this line plays the win sounds.
    audio('./media/youWon.mp3');
